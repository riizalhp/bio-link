  ...
  return (
    <div className="flex flex-col items-center">
      ...
      <div className="w-full grid grid-cols-1 gap-5">
        ...
        <div 
          className="w-full h-[350px] p-6 rounded-[24px] sm:rounded-[32px] flex flex-col justify-between text-white bg-cover bg-center"
          style={{backgroundImage: "linear-gradient(180deg, transparent, #0a1b1a), url('https://myimgs.org/storage/images/8525/VibeCourse%20(1).webp')"}}
        >
          <div className="flex justify-end">
            <div className="px-4 py-1.5 flex flex-col justify-center items-center bg-[#f4dfe2] text-black rounded-full text-center">
                <p className="text-sm font-semibold">Pre-launch</p>
            </div>
          </div>
          <div>
            <h3 className="text-xl sm:text-2xl font-semibold max-w-xs">Pre-Launching Vibe Course</h3>
            <Spacing size={4} />
            <p className="text-white/60 max-w-xs">Bergabung sebagai waiting list untuk mendapatkan update dan penawaran eksklusif.</p>
            <Spacing size={20} />
            <a href="https://vibecourse.vercel.app/" target="_blank" rel="noopener noreferrer" className="inline-flex h-12 px-4 py-3 justify-center items-center gap-2.5 rounded-2xl bg-[#78ff00] text-black font-medium transition-all duration-400 ease-in-out hover:shadow-[0_6px_20px_0_rgba(120,255,0,0.1)]">
