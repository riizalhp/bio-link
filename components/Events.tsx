...
const Events: React.FC = () => {
  return (
    <div className="flex flex-col items-center">
      ...
      <Spacing size={24} />
      <a 
        href="https://resumeai.fun" 
        target="_blank" 
        rel="noopener noreferrer" 
        className="block w-full group rounded-[24px] sm:rounded-[32px] overflow-hidden focus:outline-none focus-visible:ring-2 focus-visible:ring-[#78ff00]"
        aria-label="Event: Launching MVP Resume AI. Try it free."
      >
        <div 
          className="w-full h-[350px] p-6 flex flex-col justify-between text-white bg-cover bg-center transition-transform duration-300 ease-in-out group-hover:scale-105"
        ...
        >
          ...
          <div>
            ...
            <Spacing size={20} />
            <div className="inline-flex h-12 px-4 py-3 justify-center items-center gap-2.5 rounded-2xl bg-[#78ff00] text-black font-medium transition-all duration-400 ease-in-out group-hover:shadow-[0_6px_20px_0_rgba(120,255,0,0.1)]">
